...
import RMIT from "./pages/States/Australia/RMIT";
import UNSW from "./pages/States/Australia/UNSW";
import BriminGham from "./pages/States/UK/BRMGHM";
...
import Melbrn from "./pages/States/Australia/Melbrn";
import Macquaire from "./pages/States/Australia/Macquaire";
import Monash from "./pages/States/Australia/Monash";
import Manchester from "./pages/States/UK/Manchester";
import Shefield from "./pages/States/UK/Shefield";
import SheffieldHalam from "./pages/States/UK/SheffieldHalam";
import SaintMarys from "./pages/States/Canada/SaintMarys";
import Toronto from "./pages/States/Canada/Toronto";
import Windsor from "./pages/States/Canada/Windsor";
import UniDub from "./pages/States/Ireland/UniDub";
import Cork from "./pages/States/Ireland/Cork";
import Limerrick from "./pages/States/Ireland/limerrick";
import NUI from "./pages/States/Ireland/NUI";
import Independent from "./pages/States/Ireland/Independent";
import USA from "./pages/States/USA/USA";
//import UNSW from "./pages/States/Australia/UNSW";
//,import RMIT from "./pages/States/Australia/RMIT";
        ...
        <BrowserRouter>
          <Routes>
            <Route path="/">
              ...
              <Route path="Couselling" element={<BlogListpage1 />} />
              <Route path="Visa" element={<BlogListpage2 />} />
              <Route path="WhyRmt" element={<BlogListpage3 />} />
              <Route path="blogs/:id" element={<BlogdetailsPage />} />
              <Route path="about" element={<AboutPage2 />} />

               <Route path="contact-1" element={<ContactPage1 />} />
              <Route path="RMIT" element={<RMIT />} />
              <Route path="UNSW" element={<UNSW />} />
              <Route path="Melbourne" element={<Melbrn/>}/>
              <Route path= "Macquaire"    element = {<Macquaire/>}/>
              <Route path= "Monash"    element = {<Monash/>}/>
              <Route path="Brimingham" element={<BriminGham />} />
              <Route path="Manchester" element={<Manchester />} />
              <Route path="Sheffield" element={<Shefield/>} />
              <Route path="SheffieldHalam" element={<SheffieldHalam/>} /> 
              <Route path="SaintMarys" element={<SaintMarys />} />
              <Route path="Toronto" element={<Toronto />} />
              <Route path="Windsor" element={<Windsor />} />
              <Route path="UCD" element={<UniDub/>} />
              <Route path="NUI" element={<NUI/>} />
              <Route path="UCC" element={<Cork/>} />
              <Route path="UOL" element={<Limerrick/>} />
              <Route path="IC" element={<Independent/>} />
