          ...
          <div className="page-header__content">
            <div className="row justify-center text-center">
              <div className="col-auto">
                <div>
                  <h1 className="page-header__title">Education Fair</h1>
                </div>

                <div>
                  <p className="page-header__text">
                    We’re on a mission to deliver engaging, Counselling to search 
                    Admission in Top Universities of different States.
                    ---- Listening  , courses counselling, choosing university , admission
                  </p>
                </div>
              </div>
            </div>
