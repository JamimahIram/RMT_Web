...
import { tags, visa } from "@/data/visa";
import { Link } from "react-router-dom";
export default function VisaCosultant() {
  return (
    <>
          ...
          <div className="page-header__content">
            <div className="row justify-center">
              <div className="col-auto">
                <div>
                  <h1 className="page-header__title">Visa Facilitation</h1>
                </div>

                <div>
                  <ul>
                  <li className="page-header__text">On-line Application for speedy processing</li>

                  <li className="page-header__text">Updated Prospectuses & Access to our Reference Library </li>

                  <li className="page-header__text">IELTS Coaching In Islamabad & Lahore Offices </li>
  </ul>
                </div>
              </div>
            </div>
