          ...
          <div className="page-header__content">
            <div className="row justify-center text-center">
              <div className="col-auto">
                <div>
                  <h1 className="page-header__title"> Counselling on the basis of:</h1>
                </div>

                <div>
                  <ul>
                  <li className="page-header__text">Academic Choice Suitability (Course searching in our university-database)</li>

                  <li className="page-header__text">Learning Needs Suitability </li>

                  <li className="page-header__text">University Environment Suitability</li>
                  <li className="page-header__text">Accommodation Advice</li>
                  <li className="page-header__text">Visa Application & Documentation</li>
                  <li className="page-header__text">Connection to our International Student Support Network</li>
  </ul>
                </div>
              </div>
            </div>
