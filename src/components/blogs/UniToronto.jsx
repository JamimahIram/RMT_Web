...
export default function UniToronto() {
          ...
          <div className="page-header__content">
            <div className="row justify-center text-center">
              <div className="col-auto">
                <div>
                  <h1 className="page-header__title">University of Toronto</h1>
                </div>

                <div>
                  <p className="page-header__text">
                  Founded in 1827, the University of Toronto is Canada’s top university with a long 
                  history of challenging the impossible and transforming society through the ingenuity 
                  and resolve of its faculty, students, alumni and supporters.The University of Toronto is home to some
                  of the world's top faculty, students, alumni, staff.U of T Celebrates recognises their award-winning accomplishments.
                  </p>
                </div>
              </div>
            </div>
