...
export default function UniWindsr() {
          ...
          <div className="page-header__content">
            <div className="row justify-center text-center">
              <div className="col-auto">
                <div>
                  <h1 className="page-header__title">The University of Windsor</h1>
                </div>

                <div>
                  <p className="page-header__text">
                  The University of Windsor is a public research university in Windsor, Ontario, Canada. 
                  It is Canada's southernmost university. It has approximately 17,500 students. 
