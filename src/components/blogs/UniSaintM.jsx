...
export default function UniSaintM() {
          ...
          <div className="page-header__content">
            <div className="row justify-center text-center">
              <div className="col-auto">
                <div>
                  <h1 className="page-header__title">Saint Mary's University</h1>
                </div>

                <div>
                  <p className="page-header__text">
                  Saint Mary's University is a formerly Catholic, public university located in Halifax, Nova Scotia, Canada.
                   The school is best known for having nationally leading programs in business and chemistry. 
                  </p>
                </div>
              </div>
            </div>
