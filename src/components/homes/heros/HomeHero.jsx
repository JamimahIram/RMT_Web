...
const masthead_info = [
  {
    id: 1,
    icon: "/assets/img/masthead/icons/UK.jpg",
    text: "Over 12 million students",
  },
  {
    id: 2,
    icon: "/assets/img/masthead/icons/Canada.jpg",
    text: "More than 60,000 courses",
  },
  {
    id: 3,
    icon: "/assets/img/masthead/icons/USA.jpg",
    text: "Lets build your career",
  },
];

const hero_content = {
  title: "Student Placemnet Services with Experience",
  text_underline: "RMT Enterprise",
  info_hero: (
    <>
      Build skills with courses, certificates, and degrees from
      <br />top world-class universities of different states.
    </>
  ),
  starts: [
              ...
              <div className="masthead-image">
                <div className="masthead-image__el1">
                  <img
                    ...
                    src={"/assets/img/masthead/icons/UK.jpg"}
                    alt="image"
                  />
                  {/* <div
                    data-move="30"
                  ...
                  > */}
                    {/* <div className="size-50 d-flex justify-center items-center bg-red-2 rounded-full">
                      <img src={"/assets/img/masthead/USA.svg"} alt="icon" />
                    </div> */}
                    {/* <div className="ml-20">
                      <div className="text-orange-1 text-16 fw-500 lh-1">
                        3.000 +
                      </div>
                      <div className="mt-3">Courses</div>
                    </div> */}
                  {/* </div> */}
                </div>
                ...
                <div className="masthead-image__el2">
                  <img
                    className="js-mouse-move"
                    data-move="70"
                    src={"/assets/img/masthead/icons/Canada.jpg"}
                    style={{ objectFit: "cover" }}
                    alt="image"
                  />
                  {/* <div
                ...
                <div className="masthead-image__el3">
                  <img
                    className="js-mouse-move"
                    data-move="40"
                    src={"/assets/img/masthead/icons/USA.jpg"}
                    style={{ objectFit: "cover" }}
                    alt="image"
                  />
                  {/* <div
                  ...
                  >
                    ...
                    <div className="">
                      ...
                      <div className="mt-3">Admission Process</div>
                    </div>
                  </div> */}
                </div>
              </div>
