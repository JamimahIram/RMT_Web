      ...
      <section className="layout-pt-md layout-pb-md">
        <div className="container">
          ...
          <div className="overflow-hidden pt-50 js-section-slider">
            ...
            <div className="d-flex justify-center x-gap-15 items-center pt-60 lg:pt-20">
              <div className="col-auto">
                <button className="d-flex items-center text-18 arrow-left-hover js-prev">
              ...
              <div className="col-auto">
                <button className="d-flex items-center text-18 arrow-right-hover js-next">
