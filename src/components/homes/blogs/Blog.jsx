          ...
          <div className="col-lg-6">
            ...
            >
              ...
              <p className="sectionTitle__text ">
                Get latest updates and Resource .
              </p>
            </div>
          </div>
            ...
            >
              <div className="blogCard -type-1">
                ...
                <div className="blogCard__content">
                  <div className="blogCard__category" style={{color:"black", fontSize:16, fontWeight:800}}>{elm.category}</div>
                  <h4 className="blogCard__title" style={{color:"black"}}>
