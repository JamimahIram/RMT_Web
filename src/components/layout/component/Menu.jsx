...
export default function Menu({ allClasses, headerPosition }) {
  ...
  //         const splitHref = elm2.href.split("/");
  //         console.log("splitPathname:", splitPathname); // Debug log
  //       console.log("splitHref:", splitHref); // Debug log

  //         if (splitHref[1] === splitPathname[1]) {
  //           setMenuItem(elm.title);
  //         } else {
  //           elm2?.links?.map((elm3) => {
  //             if (elm3.href) {
  //               const splitHref3 = elm3.href.split("/");
  //               if (splitHref3[1] === splitPathname[1]) {
  //                 setMenuItem(elm.title);
  //                 setSubmenu(elm2.title);
  //               }
  //             }
        ...
        <div className="menu js-navList">
          <ul className={`${allClasses ? allClasses : ""}`}>
            ...
            <li className="menu-item-has-children">
              ...
              >
                Services <i className="icon-chevron-right text-13 ml-10"></i>
              </Link>
              <ul className="subnav">
                <li className="menu__backButton js-nav-list-back">
                  <Link to="#">
            ...
            <li className="menu-item-has-children">
              ...
              >
                Universities <i className="icon-chevron-right text-13 ml-10"></i>
              </Link>

              <ul className="subnav">
                <li className="menu__backButton js-nav-list-back">
                  <Link to="#">
                    <i className="icon-chevron-left text-13 mr-10"></i> Universities
                  </Link>
                </li>
                <li className="menu-item-has-children">
                  <Link
                  ...
                  >
                    Australia<div className="icon-chevron-right text-11"></div>
                  </Link>
                ...
                <li className="menu-item-has-children">
                  ...
                  >
                    United Kingdon<div className="icon-chevron-right text-11"></div>
                  </Link>
                  <ul className="subnav">
                    <li className="menu__backButton js-nav-list-back">
                      <Link to="#">
                ...
                <li className="menu-item-has-children">
                  ...
                  >
                    ...
                    Canada<div className="icon-chevron-right text-11"></div> 
                  </Link>
                  <ul className="subnav">
                    <li className="menu__backButton js-nav-list-back">
                      <Link to="#">
                        <i className="icon-chevron-left text-13 mr-10"></i> Canada
                      </Link>
                    </li>
                ...
                <li className="menu-item-has-children">
                  ...
                  >
                    ...
                    Ireland<div className="icon-chevron-right text-11"></div> 
                  </Link>
                  <ul className="subnav">
                    <li className="menu__backButton js-nav-list-back">
                      <Link to="#">
                        <i className="icon-chevron-left text-13 mr-10"></i> Ireland
                      </Link>
                    </li>
